  ...
  <div class="flex flex-col flex-1 items-center">
    ...
    <div class="flex flex-col items-center text-white py-12">
      ...
      <p class="text-sm mb-12">
        {{
          new Date(weatherData.currentTime).toLocaleDateString("zh-cn", {
            weekday: "short",
            day: "2-digit",
            month: "long",
          })
        ...
        <div class="flex gap-10 overflow-x-scroll scrollbar">
          ...
          >
            <p class="whitespace-nowrap text-md">
              {{
                new Date(hourData.currentTime).toLocaleTimeString("zh-cn", {
                  hour: "numeric",
                })
              }}
            </p>
      ...
      <div class="mx-8 text-white">
        ...
        >
          ...
          <div class="flex gap-2 flex-1 justify-end">
            <p class="w-[96px]">最高气温:{{ Math.round(day.temp.max) }}&deg</p>
            <p class="w-[96px]">最低气温:{{ Math.round(day.temp.min) }}&deg</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div
      class="flex items-center gap-2 py-12 text-white cursor-pointer duration-150 hover:text-amber-600"
      @click="removeCity"
    >
